...
function bindUiEvents(){
  ...
  const namedAllow=new Set([
    ...
    'goPage','toggleCustomFocusEdit','createStarterForPage','applyFinanceQuickAdd','setFinanceFilter','setFinanceMonth','toggleCustomItemEdit','delCustomItem',
  ...
  const clickActions={
    ...
    openWeeklyReview:()=>call('openWeeklyReview'),
    saveWeeklyReview:()=>call('saveWeeklyReview'),
    closeWeeklyReview:()=>call('closeWeeklyReview'),
    togglePomodoroMode:()=>call('togglePomodoroMode'),
    acceptContextualChallenge:()=>call('acceptContextualChallenge'),
    ...
    checkForPwaUpdate:()=>call('checkForPwaUpdate'),
    reloadAppForUpdate:()=>call('reloadAppForUpdate'),
  ...
  const changeActions={
    ...
    setHabitReminder:(el)=>call('setHabitReminder',el),
