...
function bindUiEvents(){
  ...
  const namedAllow=new Set([
    ...
    'runSettingsAction','applyQuickTemplate','useStreakShield','buyShopItem','equipCosmetic',
    'startMission','snoozeMission','completeMissionDirect','openMissionFocus','closeMissionFocus',
    'toggleMissionFocusPause','completeMissionFromFocus','saveOwnFriendProfile','copyOwnFriendId',
    'saveFriendTarget','selectFriendContact','addSuggestedFriend','backToFriendList','sendFriendMessage',
    'respondFriendRequest','closeFriendChat','openFriendPanel','toggleFriend','togglePageObjectiveEdit',
