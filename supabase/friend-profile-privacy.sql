-- NIGHT CITY // Commlink profile privacy migration
--
-- Public directory:
--   exposes only owner, nick, tag, name and level for search/discovery.
-- Detailed profile:
--   direct table SELECT is limited to the owner or mutual contacts saved in
--   user_data.friendTargets / user_data.friendTarget.
